...
const StoreInfoPage = () => {
    ...
    return (
        <div className="info-container">
            ...
            <p className="info-subtitle">{store.description}</p>
            ...
            <div className="info-grid">
                ...
                <div className="info-card">
                    ...
                    <div className="info-row">
                        ...
                        <span className="value">{store.addr} {store.addrDetail}</span>
                    </div>
                    ...
                    <div className="info-row">
                        ...
                        <span className="value">{store.regionSi} {store.regionGun}</span>
                    </div>
                </div>
                ...
                <div className="info-card">
                    ...
                    <div className="info-row">
                        ...
                        <span className="value">{store.bizNo}</span>
                    </div>

                    <div className="info-row">
                        <span className="label">정산 은행명</span>
                        <span className="value">{store.bankName}</span>
                    </div>

                    <div className="info-row">
                        <span className="label">정산 계좌번호</span>
                        <span className="value">{store.bankAccountNo}</span>
                    </div>

                    <div className="info-row">
                        <span className="label">예금주</span>
                        <span className="value">{store.accountHolder}</span>
                    </div>
                </div>
