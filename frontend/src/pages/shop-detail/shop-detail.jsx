// src/pages/shop-detail/shop-detail.jsx
            ...
            <div className="col-lg-8 col-xl-9">
              <div className="row g-4">
                ...
                <div className="col-lg-6">
                  ...
                  <p className="mb-4">
                    Susp endisse ultricies nisi vel quam suscipit. Sabertooth peacock flounder; chain pickerel hatchetfish,
                  ...
                  <div className="row g-4">
                    ...
                    <div className="col-lg-12">
                      <div className="d-flex justify-content-between py-3 mb-5">
                        ...
                        <a href="#" className="btn border border-secondary text-primary rounded-pill px-4 py-3">
                          {" "}
                          Post Comment
                        </a>
                      </div>
